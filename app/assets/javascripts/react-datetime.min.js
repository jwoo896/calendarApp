  ...
  return (function(e) {
        ...
        l = i({
          ...
          getInitialState: function() {
            ...
            return void 0 === e.open &&
              (e.open = !this.props.input), (e.currentView = this.props
              .dateFormat
          ...
          getStateFromProps: function(e) {
            ...
            return a && 'string' == typeof a
              ? (t = this.localMoment(a, i.datetime))
              : a && (t = this.localMoment(a)), t &&
              !t.isValid() &&
              (t = null), (n = t
              ? t.clone().startOf('month')
              : this.localMoment().startOf('month')), (r = this.getUpdateOn(
              i
            )), (o = t
              ? t.format(i.datetime)
              : a.isValid && !a.isValid() ? '' : a || ''), {
              updateOn: r,
          ...
          getFormats: function(e) {
            ...
            return t.date === !0
              ...
              : 'days' !== this.getUpdateOn(t) && (t.time = ''), t.time ===
              !0 && (t.time = n.longDateFormat('LT')), (t.datetime =
              t.date && t.time ? t.date + ' ' + t.time : t.date || t.time), t;
          },
          componentWillReceiveProps: function(e) {
            ...
            if (
              (
                ...
                void 0 === n.open &&
                  (this.props.closeOnSelect && 'time' !== this.state.currentView
                    ? (n.open = !1)
            ...
            if (
              ...
              for (
                n.viewDate = n.viewDate || this.state.viewDate;
                !this.props.isValidDate(n.viewDate);
          ...
          onInputChange: function(e) {
            var t = null === e.target ? e : e.target.value,
              ...
              r = { inputValue: t };
            return n.isValid() && !this.props.value
              ? (
                  (r.selectedDate = n),
                  (r.viewDate = n.clone().startOf('month'))
                )
              : (r.selectedDate = null), this.setState(r, function() {
          ...
          showView: function(e) {
            var t = this;
            return function() {
              t.state.currentView !== e &&
                t.props.onViewModeChange(e), t.setState({ currentView: e });
            };
          },
          setDate: function(e) {
            var t = this,
          ...
          render: function() {
            ...
            return this.props.input
              ...
              : (e += ' rdtStatic'), this.state.open &&
              (e += ' rdtOpen'), s.createElement(
              'div',
              { className: e },
              t.concat(
                s.createElement(
    ...
    function(e, t) {
      ...
      function a() {
        m &&
          h &&
          ((m = !1), h.length ? (f = h.concat(f)) : (y = -1), f.length && s());
      }
      function s() {
        if (!m) {
          var e = o(a);
                ...
                if (r.hasOwnProperty(a) && a !== l) {
                  ...
                  if ((d(p, a), w.hasOwnProperty(a))) w[a](e, u);
                    ...
                    if (m) i.push(a, u), (o[a] = u);
                      ...
                      (o[a] = u), 'production' !== t.env.NODE_ENV &&
                        'function' == typeof u &&
                        r.displayName &&
          ...
          function D(e) {
            var n = r(function(e, r, i) {
              'production' !== t.env.NODE_ENV &&
                ...
                ), this.__reactAutoBindPairs.length && g(this), (this.props = e), (this.context = r), (this.refs = a), (this.updater = i || o), (this.state = null);
              var u = this.getInitialState ? this.getInitialState() : null;
              'production' !== t.env.NODE_ENV &&
                void 0 === u &&
                this.getInitialState._isMockFunction &&
                (u = null), s('object' == typeof u && !Array.isArray(u), '%s.getInitialState(): must return an object or null', n.displayName || 'ReactCompositeComponent'), (this.state = u);
            });
            (n.prototype = new x()), (n.prototype.constructor = n), (n.prototype.__reactAutoBindPairs = []), O.forEach(
              h.bind(null, n)
            ), h(n, N), h(n, e), h(n, C), n.getDefaultProps &&
          ...
          var O = [],
            ...
            w = {
              ...
              childContextTypes: function(e, n) {
                'production' !== t.env.NODE_ENV &&
                  p(e, n, 'childContext'), (e.childContextTypes = i(
                  {},
                  e.childContextTypes,
                  n
                ));
              ...
              contextTypes: function(e, n) {
                'production' !== t.env.NODE_ENV &&
                  p(e, n, 'context'), (e.contextTypes = i(
                  {},
                  e.contextTypes,
                  n
                ));
              ...
              propTypes: function(e, n) {
                'production' !== t.env.NODE_ENV &&
                  p(e, n, 'prop'), (e.propTypes = i({}, e.propTypes, n));
              },
              ...
              for (var m = c.clone().add(42, 'd'); c.isBefore(m); )
                ...
                c.year() < u
                  ...
                  : ((c.year() === u && c.month() > l) || c.year() > u) &&
                    (e += ' rdtNew'), s &&
                  c.isSame(s, 'day') &&
                  (e += ' rdtActive'), c.isSame(i(), 'day') &&
                  (e += ' rdtToday'), (t = !f(o, s)), t &&
                  (e += ' rdtDisabled'), (n = {
                  key: c.format('M_D'),
                  'data-value': c.date(),
                  className: e
                }), t || (n.onClick = this.updateSelectedDate), d.push(
                  h(n, o, s)
                ), 7 === d.length &&
                  (
            ...
            var i = r({
              ...
              componentDidMount: function() {
                if ('undefined' != typeof document && document.createElement) {
                  ...
                  if (o && 'function' == typeof o.handleClickOutside) {
                    ...
                    e = t.Component.prototype.isPrototypeOf(r)
                      ? r.handleClickOutside.bind(r)
                  ...
                  var a = (this.__outsideClickHandler = m(
                      i,
                      r,
                      e,
                      this.props.outsideClickIgnoreClass || l,
                      this.props.excludeScrollbar,
                      this.props.preventDefault || !1,
                      this.props.stopPropagation || !1
                    )),
                    s = c.length;
                  c.push(this), (u[s] = a), this.props.disableOnClickOutside ||
              ...
              render: function() {
                ...
                return Object.keys(this.props).forEach(function(e) {
                  ...
                  (r.ref =
                    'instance'), (r.disableOnClickOutside = this.disableOnClickOutside), (r.enableOnClickOutside = this.enableOnClickOutside), t.createElement(
                  e,
                  r
                );
              }
          ...
          i({
            ...
            renderMonths: function() {
              for (
                ...
                (e = 'rdtMonth'), (n = this.props.viewDate
                  .clone()
                  .set({ year: l, month: d, date: y })), (i = n
                  .endOf('month')
                  .format('D')), (a = Array.from({ length: i }, function(e, t) {
                  return t + 1;
                })), (s = a.find(function(e) {
                  var t = n.clone().set('date', e);
                  return m(t);
                })), (r = void 0 === s), r && (e += ' rdtDisabled'), c &&
                  d === c.month() &&
                  l === c.year() &&
                  (e += ' rdtActive'), (t = {
                  key: d,
                  ...
                  (t.onClick =
                    'months' === this.props.updateOn
                      ...
                      : this.props.setDate('month')), h.push(
                  f(t, d, l, c && c.clone())
                ), 4 === h.length &&
                  (
                    p.push(
                      o.createElement('tr', { key: u + '_' + p.length }, h)
                    ),
                    (h = [])
                  ), d++;
              return p;
          ...
          o({
            ...
            renderYears: function(e) {
              var t,
                ...
                y = 1;
              for (e--; l < 11; )
                (t = 'rdtYear'), (o = this.props.viewDate
                  .clone()
                  .set({ year: e, month: m, date: y })), (a = o
                  .endOf('year')
                  .format('DDD')), (s = Array.from({ length: a }, function(
                  e,
                  t
                ) {
                  return t + 1;
                  ...
                  (n.onClick =
                    'years' === this.props.updateOn
                      ...
                      : this.props.setDate('year')), u.push(
                  d(n, e, h && h.clone())
                ), 4 === u.length &&
                  (
                    p.push(r.createElement('tr', { key: l }, u)),
                    (u = [])
                  ), e++, l++;
              return p;
            },
        ...
        s = a(
          o({
            ...
            render: function() {
              ...
              }), this.state.daypart !== !1 && t.push(e.renderDayPart()), 3 ===
            ...
            onStartClicking: function(e, t) {
              ...
              return function() {
                ...
                (r[t] = n[e](t)), n.setState(
                  ...
                  clearTimeout(n.timer), clearInterval(
                    n.increaseTimer
                  ), n.props.setTime(
                    t,
                    n.state[t]
            ...
            toggleDayPart: function(e) {
              ...
              return t > this.timeConstraints[e].max &&
                (t =
                  this.timeConstraints[e].min +
                  (t - (this.timeConstraints[e].max + 1))), this.pad(e, t);
            },
            increase: function(e) {
              var t =
                parseInt(this.state[e], 10) + this.timeConstraints[e].step;
              return t > this.timeConstraints[e].max &&
                (t =
                  this.timeConstraints[e].min +
                  (t - (this.timeConstraints[e].max + 1))), this.pad(e, t);
            ...
            decrease: function(e) {
              var t =
                parseInt(this.state[e], 10) - this.timeConstraints[e].step;
              return t < this.timeConstraints[e].min &&
                (t =
                  this.timeConstraints[e].max +
                  1 -
                  (this.timeConstraints[e].min - t)), this.pad(e, t);
            },
            pad: function(e, t) {
